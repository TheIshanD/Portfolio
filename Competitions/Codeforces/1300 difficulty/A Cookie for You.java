...
public class Main{
    ...
    static class TaskB {
        public void solve(InputReader in, PrintWriter out) {
            ...
            {
                long cook1 = in.nextLong();
                long cook2 = in.nextLong();
 
                long numPeople1 = in.nextLong();
                long numPeople2 = in.nextLong();
 
                if((cook1+cook2)<(numPeople1+numPeople2))
                {
                    out.println("No");
                    continue;
                }
 
                long min = Math.min(cook1, cook2);
                long max = Math.max(cook1, cook2);
 
                if(numPeople2<=min && numPeople1<=max){
                    out.println("Yes");
                    continue;
                }
